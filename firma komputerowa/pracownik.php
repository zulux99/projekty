    ...
    if(isset($_POST['zapisz']))
    {
        ...
        if(!empty($_POST['imied'])&&!empty($_POST['nazwiskod'])&&!empty($_POST['adres_md'])&&!empty($_POST['adres_nrd'])&&!empty($_POST['peseld'])&&!empty($_POST['telefond']))
        {
          ...
          while (isset($_POST['id'.$a])) {
            ...
            fwrite($fp, "150"." || ".$_POST['imied']." || ".$_POST['nazwiskod']." || ".$_POST['adres_md']." || ".$_POST['adres_uld']." || ".$_POST['adres_nrd']." || ".$_POST['peseld']." || ".$_POST['telefond']." || "."
"); 
        }
        while(isset($_POST['nazwisko'.$i]))
        {
            $file="pracownik.txt";
            $linie = 0;
...
<body>
    ...
    <?php
    echo 
    "<tr><td><input type='text' class='tabela' value='1502' name='idd' ><input type='text' class='tabela' value='' name='imied' placeholder='Dodaj imię'></td>
    ...
    if(file_exists("pracownik.txt")&&file_get_contents("pracownik.txt"))
    {
        ...
        {
          echo 
          "<tr><td><input type='text' class='tabela' value='$id[$i]' name='id$i' ><input type='text' class='tabela' value='$imie[$i]' name='imie$i'></td>
  ...
  echo "</table>";
/*
1 || hdas || hsa || hsdah || as || hs || dhds || hdas || 
2 || bh || bhk || bk || bkj || bk || jb || kjl || 
3 || hdas || hsa || hsdah || as || hs || dhds || hdas || 
4 || bh || bhk || bk || bkj || bk || jb || kjl || 
5 || hdas || hsa || hsdah || as || hs || dhds || hdas || 
6 || bh || bhk || bk || bkj || bk || jb || kjl || 
7 || hdas || hsa || hsdah || as || hs || dhds || hdas || 
8 || bh || bhk || bk || bkj || bk || jb || kjl || 
9 || hdas || hsa || hsdah || as || hs || dhds || hdas || 
10 || bh || bhk || bk || bkj || bk || jb || kjl || 
*/
  ?>
</form>
</body>
